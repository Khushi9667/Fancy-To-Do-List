...
import { Box, Checkbox, Divider, IconButton, InputAdornment, List, ListItem, ListItemButton, ListItemIcon, ListItemText, TextField, Toolbar, Typography } from '@mui/material';
...
export function CurrentToDoList() {
  ...
  const { data, newItem, deleteItem, toggleChecked, updateItem } = useToDoList(currentList);
